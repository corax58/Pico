...
const PostCard = () => {
  ...
  return (
    <Link to={`/post/${post._id}`}>
     <div className=' shadow-xl bg-slate-50   w-60 h-max  hover:shadow-2xl rounded-3xl overflow-hidden m-5 hover:scale-105 transition-all duration-200 '>
<div className=' h-max w-full bg-white pt-2 px-3'>
    {post.imageUrls.length<2 ?(
        <div className='h-full w-full rounded-2xl overflow-hidden bg-green-500 flex justify-center'>
...
<div className='flex space-x-2'><img src={post.postedBy.profile} alt="" className='h-8 w-8 rounded-full' />
